...
function handleClick(clickedButtonEvent) {
    ...
    if (card.button.innerText === 'Подробнее') {
        ...
        showMoreText(card);
    } else if (card.button.innerText === 'Отмена') {
...
function showMoreText(card) {
    ...
    card.wrap.querySelector('.desc').style.fontSize = '16px';
    card.wrap.querySelector('.desc').style.boxSizing = 'border-box';
    card.wrap.querySelector('.desc').style.padding = '15px 0';
    card.wrap.querySelector('.desc').style.height = '150px';
